...
class FinalWin(QWidget):
    ...
    def initUI(self):
        ...
        self.label_perform = QLabel(txt_workheart + str(self.results()))
    ...
    def results(self):
        ...
        # sebagai tugas untuk melakukan proses seleksi hasil dari indeks rufier
            ...
            if self.index >= 18:
                return text_res1
            elif self.index >= 14 and self.index < 115:
                return text_res2
                ...
                return text_res5
        elif self.exp.age >= 9 and self.expage < 11:
            if self.index >= 19.5:
                return text_res1
            elif self.index >= 15.5 and self.index < 19.5:
                return text_res2
            elif self.index >= 10.5 and self.index < 115.5:
                return text_res3
            ...
            if self.index >= 21:
                ...
                return text_res3
            elif self.index >= 6.5 and self.index < 126:
                return text_res4
            elif self.index < 6.5:
                return text_res5